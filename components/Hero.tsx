...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center justify-center bg-regal-cream overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center md:text-left space-y-6">
          ...
          <div className="pt-8 border-t border-slate-200 mt-8 flex flex-wrap gap-4 md:gap-8 justify-center md:justify-start text-sm md:text-base font-sans text-slate-500 tracking-wide uppercase">
        ...
        <div className="relative">
           <div className="relative aspect-[3/4] md:aspect-[4/5] w-full max-w-md mx-auto rounded-t-[100px] rounded-b-lg overflow-hidden shadow-2xl border-4 border-white">
              <img 
                ...
                alt="Valentina Alberti in un ambiente naturale" 
